...
export const PROJECT_CONTENT: Record<Lang, Record<string, { name: string; description: string }>> = {
  en: {},
  ko: {
    analytics: {
      name: "애널리틱스",
      description: "주니어 시절에 만든 웹사이트 및 모바일 앱 트래픽 분석 서비스.",
    },
    hellostranger: {
      name: "헬로 스트레인저 채팅",
      description: "WebRTC 기반 랜덤 영상 채팅. 계정 없이 낯선 사람과 즉시 연결. 프라이버시 우선 설계.",
    },
    chat: {
      name: "프라이빗 채팅",
      description: "Socket 기반 1:1 텍스트 채팅. 계정 없이 바로 연결 가능. 프라이버시 우선 설계.",
    },
    "smart-scheduler": {
      name: "스마트 학습 스케줄러",
      description: "우선순위 큐, 동적 일정 조정, 자기 개선 기능을 갖춘 AI 기반 학습 스케줄러.",
    },
    "glasscube-portfolio": {
      name: "글래스큐브 포트폴리오",
      description: "이 포트폴리오. 터미널 감성 UI, 다국어 지원, 부팅 시퀀스, Tron 영감 디자인.",
    },
    playwright: {
      name: "플레이라이트 데모",
    ...
    botanik: {
      name: "보타닉",
      description: "코드베이스를 분석해 테스트를 자동 생성·실행하고 문서도 제공하는 CLI 도구. 백/프론트 개발 모두에 유용.",
    },
    financemate: {
      name: "파이낸스메이트",
      description: "거래 분류, 지출 분석, 예산 목표 추적 기능의 개인 재무 대시보드.",
    },
  },
  uz: {
    analytics: {
      name: "Analytics",
      description: "Junior yilida yaratilgan veb va mobil ilova trafigini tahlil qilish xizmati.",
    },
    hellostranger: {
      name: "Begona bilan Chat",
      description: "WebRTC asosida tasodifiy video chat. Hisob kerak emas, darhol bog'laning.",
    },
    chat: {
      name: "Maxfiy Chat",
      description: "Socket asosida shaxsiy matnli chat. Hisob kerak emas, darhol ulanish.",
    },
    "smart-scheduler": {
      name: "Aqlli O'quv Rejalashtiruvchi",
      description: "Ustuvorlik navbatlari va dinamik o'zgarishlar bilan AI yordamchi o'quv rejalashtiruvchi.",
    },
    "glasscube-portfolio": {
      name: "GlassCube Portfolio",
      description: "Ushbu portfolio. Terminal estetikasi, ko'p tilli qo'llab-quvvatlash va Tron dizayni.",
    },
    playwright: {
    ...
    botanik: {
      name: "Botanik",
      description: "Kodni o'qib, testlarni avtomatik yaratib ishlatadigan va hujjatlar taqdim etadigan CLI vosita.",
    },
    financemate: {
      name: "Moliya Yordamchi",
      description: "Tranzaksiyalar tasnifi, xarajat tahlili va byudjet kuzatuvi bilan shaxsiy moliya paneli.",
    },
  },
  ru: {
    analytics: {
      name: "Аналитика",
      description: "Сервис аналитики трафика для сайтов и мобильных приложений, создан в студенческие годы.",
    },
    hellostranger: {
      name: "Чат с Незнакомцем",
      description: "Случайный видеочат на WebRTC. Без регистрации — мгновенное соединение с незнакомцем.",
    },
    chat: {
      name: "Приватный Чат",
      description: "Приватный чат на Socket.io. Без регистрации — мгновенное соединение один на один.",
    },
    "smart-scheduler": {
      name: "Умный Планировщик",
      description: "AI-планировщик учёбы с очередями приоритетов, динамическим расписанием и самосовершенствованием.",
    },
    "glasscube-portfolio": {
      name: "GlassCube Портфолио",
      description: "Это портфолио. Терминальная эстетика, мультиязычность, загрузочная анимация, стиль Tron.",
    },
    playwright: {
    ...
    botanik: {
      name: "Botanik",
      description: "CLI-инструмент: читает код, автоматически создаёт и запускает тесты, генерирует документацию.",
    },
    financemate: {
      name: "ФинансПомощник",
      description: "Дашборд личных финансов: категоризация транзакций, аналитика расходов, отслеживание бюджета.",
    },
  },
};
